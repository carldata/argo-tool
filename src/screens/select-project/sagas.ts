...
import { ProjectConfigurationLoadStartedAction, ProjectConfigurationLoadSucceededAction } from '@screens/select-project/actions';
...
export function* loadProjectSaga() {
  while (true) {
    ...
    try {
      ...
      yield put(_.toPlainObject(new ProjectConfigurationLoadStartedAction()));
      ...
      yield put(_.toPlainObject(new ProjectConfigurationLoadSucceededAction()));
